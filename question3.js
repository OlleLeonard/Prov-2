...
function filterProductsByPriceRange(produListct, minPrice, maxPrice) {
    return produListct.filter((products) => {
  
        const cost = products.price >= 110;
        return products.price >= 110;
      });
  }
